...
export EXTRA_VARS="--web-server=nginx --php-version=7.1 --nodejs-version=6 --ruby-version=2.4.0 --solr-version=7.7.2 --mssql-install --psql-install --mongodb-install=no"
